...
private:
  ...
  {
    _angles = angles;
    std::vector<float> angles_v = {3*_angles.theta_l1, 3*_angles.theta_l1, _angles.theta_l2, _angles.theta_l2, _angles.theta_l3, _angles.theta_l4, _angles.theta_l5, _angles.theta_l6,
                                   3*_angles.theta_r1, 3*_angles.theta_r1, _angles.theta_r2, _angles.theta_r2, _angles.theta_r3, _angles.theta_r4, _angles.theta_r5, _angles.theta_r6,};
