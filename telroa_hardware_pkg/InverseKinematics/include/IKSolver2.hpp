...
Eigen::Matrix<float,5,1> ComputeNumericalInverseKinematicsPosition(const Eigen::Matrix<float,5,1>& currentTheta,
																   const Eigen::Matrix<float,3,1>& desiredPosition);
